(ns marketentry.store
  "SSoT for the MUS market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  lifecycles (draft, submit) plus the governor's own new checks: a
  clean case (eng-1), a jurisdiction with no spec-basis (eng-2), a
  fee-mismatch case (eng-3), a missing-CBRIS-registration case
  (eng-4), a missing-e-Procurement-registration case (eng-5), and a
  second clean case for double-draft/double-submit tests (eng-6)."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Grand Baie Digital Ltd" :portal "PPO e-Procurement System"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-cbris-registration? true :has-cbris-registration? true
             :requires-eprocurement-registration? true :eprocurement-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MUS" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "PPO e-Procurement System"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-cbris-registration? true :has-cbris-registration? true
             :requires-eprocurement-registration? true :eprocurement-registration-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Port Louis Analytics Ltd" :portal "PPO e-Procurement System"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MUS" :status :intake}
    "eng-4" {:id "eng-4" :operator "Curepipe Exports Ltd" :portal "PPO e-Procurement System"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-cbris-registration? true :has-cbris-registration? false
             :requires-eprocurement-registration? true :eprocurement-registration-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MUS" :status :intake}
    "eng-5" {:id "eng-5" :operator "Flic en Flac Logistics Ltd" :portal "PPO e-Procurement System"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-cbris-registration? true :has-cbris-registration? true
             :requires-eprocurement-registration? true :eprocurement-registration-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MUS" :status :intake}
    "eng-6" {:id "eng-6" :operator "Rose Hill Civic Tech Ltd" :portal "PPO e-Procurement System"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-cbris-registration? has-cbris-registration?
                               requires-eprocurement-registration? eprocurement-registration-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-cbris-registration?)  (assoc :engagement/requires-cbris-registration? requires-cbris-registration?)
    (some? has-cbris-registration?)       (assoc :engagement/has-cbris-registration? has-cbris-registration?)
    (some? requires-eprocurement-registration?) (assoc :engagement/requires-eprocurement-registration? requires-eprocurement-registration?)
    (some? eprocurement-registration-verified?) (assoc :engagement/eprocurement-registration-verified? eprocurement-registration-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-cbris-registration? :engagement/has-cbris-registration?
   :engagement/requires-eprocurement-registration? :engagement/eprocurement-registration-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-cbris-registration? (boolean (:engagement/requires-cbris-registration? m))
     :has-cbris-registration? (boolean (:engagement/has-cbris-registration? m))
     :requires-eprocurement-registration? (boolean (:engagement/requires-eprocurement-registration? m))
     :eprocurement-registration-verified? (boolean (:engagement/eprocurement-registration-verified? m))
